...
void handle_user_id(http_response_writer_t writer, http_request_t* request) {
    (void)request;
}

void handle_user_id_okej(http_response_writer_t writer, http_request_t* request) {
    (void)request;
}

void handle_user_id_friends(http_response_writer_t writer, http_request_t* request) {
    (void)request;
}
...
u8 http_router__should_register_route_and_find_handler(void) {
    ...
    http_router_add(&router, HTTP_METHOD_GET, "/users/:id/*", handle_user_id_okej);
